...
public class UserController {
    ...
    public ResponseEntity<User> getUserById(@PathVariable("idUser") final Long id) throws SQLException {
    ...
    public ResponseEntity<User> getUserByNickName(@PathVariable("nickName") final String nickName) throws SQLException {
    ...
    public ResponseEntity<User> getUserByName(@PathVariable("firstName") final String firstName) throws SQLException {
